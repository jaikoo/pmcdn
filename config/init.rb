...
require 'aws/s3'
begin
  conf = YAML.load_file("#{Merb.root}/config/s3_conf.yml")[Merb.environment]
  AWS::S3::Base.establish_connection!(:access_key_id     => conf['access_key'], :secret_access_key =>  conf['secret_access_key'])
rescue Exception => e
  puts "There was a problem loading your s3 configuration"
end
...
Merb::Config.use do |c|
  ...
  c[:session_secret_key]  = '96d73bcad4f10495307a963ee0dfb02bcd362f78'
